...
const DashboardUser = () => {
  ...
  const [profileV, setProfileV] = React.useState({
    ...
    datasets: [
      {
        label: "Profile Views",
        data: datas.map((datas) => datas.ProfileView),
  ...
  const [postV, setPostV] = React.useState({
    ...
    datasets: [
      {
        label: "Post View",
        data: datas.map((datas) => datas.PostView),
              ...
              <Grid container spacing={6}>
                <Grid item lg={3}>
                  ...
                  >
                    ...
                    />
                    <Typography
                      sx={{ mt: "30px", fontWeight: "bold", color: "gray" }}
                    >
                      Total Comments
                    </Typography>
                    ...
                    <Typography sx={{ color: "#ee05fa", fontWeight: "bold" }}>
                      Growth rate: 20%
                    </Typography>
                  </StyledBox>
                </Grid>
                <Grid item lg={3}>
                  ...
                  >
                    ...
                    <Typography sx={{ color: "#05fa22", fontWeight: "bold" }}>
                      Growth rate: 30%
                    </Typography>
                  </StyledBox>
                </Grid>
                <Grid item lg={3}>
                  ...
                  >
                    ...
                    <Typography sx={{ color: "#fcb900", fontWeight: "bold" }}>
                      Growth rate: 40%
                    </Typography>
                  </StyledBox>
                </Grid>
                <Grid item lg={3}>
                  ...
                  >
                    ...
                    <Typography sx={{ color: "#474acc", fontWeight: "bold" }}>
                      Growth rate: 50%
                    </Typography>
                  </StyledBox>
                </Grid>
